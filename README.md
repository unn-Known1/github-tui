...
- Mostly read-only client today — actions ship in waves:
  ...
  - ✅ **shipped (v0.5.5):** rate limit indicator, traffic/milestones/labels/checks/security panes, mouse support, collapsible sections, hover effects, followers section.
...
**Shipped in v0.5.5 (this release):**
