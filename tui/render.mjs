...
function statusLine() {
  ...
  switch (tabState.current) {
    ...
    case 2: {
      ...
      if (v === 'details') return ' [Enter] Forks/Issue' + sep + '[O] Overview' + sep + '[i] Issues' + sep + '[P] PRs' + sep + '[R] README' + sep + '[F] Files' + sep + '[T] Traffic' + sep + '[M] Milestones' + sep + '[L] Labels' + sep + '[K] Checks';
