...
const THEMES = {
  ...
  light: {
    ...
    info: { fg: 'blue' },
    selection: { bg: 'blue', fg: 'white', bold: true },
    selectionDim: { bg: 'gray', fg: 'black' },
    header: { fg: 'black', bold: true, underline: true },
    statusBar: { bg: 'gray', fg: 'black' },
    chrome: { bg: 'gray', fg: 'black' },
    chromeAccent: { bg: 'gray', fg: 'blue', bold: true },
    tabInactive: { fg: 'gray' },
    tabActive: { fg: 'blue', bold: true },
    tabActiveBg: { bg: 'blue', fg: 'white', bold: true },
    tabBadge: { bg: 'yellow', fg: 'black', bold: true },
    ...
    rateWarn: { fg: 'yellow' },
    rateCrit: { fg: 'red' },
    toastInfo: { bg: 'gray', fg: 'blue', bold: true },
    toastSuccess: { bg: 'gray', fg: 'green', bold: true },
    toastError: { bg: 'gray', fg: 'red', bold: true },
    toastWarning: { bg: 'gray', fg: 'yellow', bold: true },
    sectionHeading: { fg: 'blue', bold: true },
    repoName: { fg: 'black' },
    repoNameSelected: { fg: 'black', bold: true },
    statValue: { fg: 'black', bold: true },
    date: { fg: 'gray' },
    packageName: { fg: 'blue' },
    packageTag: { fg: 'yellow' },
    packageSize: { fg: 'gray' },
    downloadCount: { fg: 'gray' },
    pinned: { fg: 'yellow', bold: true },
    bookmarked: { fg: 'magenta' },
    cardBorder: { fg: 'gray' },
    cardBorderFocused: { fg: 'blue', bold: true },
    listItem: { fg: 'black' },
    listItemDim: { fg: 'gray' },
    emptyIcon: { fg: 'blue' },
    emptyTitle: { fg: 'black', bold: true },
    emptyMessage: { fg: 'gray' },
    heatmapLow: { fg: 'green', dim: true },
    heatmapMid: { fg: 'green' },
    heatmapHigh: { fg: 'green', bold: true },
    traffic: { fg: 'blue' },
