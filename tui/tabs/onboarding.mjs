  ...
  return [
    ...
    buildLoginStep(),
    {
      ...
      body: [
        ...
        '  [Ctrl-S]  save the current search (any tab with a query)',
        '  [Ctrl-K]  show the custom keybindings path (toast, no editor)',
        '  [?]       show keyboard shortcuts help',
        '  [q]       quit',
        '  [r]       retry when offered, otherwise refresh the current view',
      ],
